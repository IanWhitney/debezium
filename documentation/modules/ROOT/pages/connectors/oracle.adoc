...
GRANT SELECT ON V$LOGMNR_LOGS TO c##logminer CONTAINER=ALL;
GRANT SELECT ON V$LOGMNR_CONTENTS TO c##logminer CONTAINER=ALL;
GRANT SELECT ON V$LOGFILE TO c##logminer CONTAINER=ALL;
GRANT SELECT ON V$ARCHIVED_LOG TO c##logminer CONTAINER=ALL;
GRANT SELECT ON V$ARCHIVE_DEST_STATUS TO c##logminer CONTAINER=ALL;
